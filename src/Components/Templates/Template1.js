...
function Template1() {
  ...
  return (
    <div className="mb-5 p-4 w-100" style={{ backgroundColor:"biege"}}>
        <div >
            <div className="row  m-0 d-flex align-items-center" style={{height:"200px"}}>
                ...
                <div className="col-6    text-left font-weight-bold " style={{fontFamily:"Serif"}}>
                    <div className=' d-flex justify-content-center' style={{color:"#FF5757",fontSize:"55px"}}>{ dataStore.personalInfo.firstName +" "+  dataStore.personalInfo.lastName}</div>
        ...
        <hr style={{height:"5px",backgroundColor:"#FF5757"}}/>
        <div className="text-justify mx-4">{dataStore.personalInfo.Objective}</div>
        <hr style={{height:"5px",backgroundColor:"#FF5757"}}/>

        <div className="container" style={{fontFamily:"Serif",}}>
            <div className="row">
                <div className="col-3 text-left  " style={{color:"#FF5757"}}> <h4> Professional Experience</h4></div>
                ...
                <hr style={{height:"5px",backgroundColor:"#FF5757"}}/>
                <div className="col-3 text-left" style={{color:"#FF5757"}}><h4>Education</h4></div>
                ...
                <div className="col-3 text-left " >
                    <h4 style={{color:"#FF5757"}}>Key Skills</h4>
                </div>
                <div className="col-9 text-left" style={{fontSize:"18px"}}>
