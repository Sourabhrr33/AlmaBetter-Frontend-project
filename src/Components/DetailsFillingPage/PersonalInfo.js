...
import ProfilePicUploadComponent from './ProfileAvtar'
...
import { updatePersonalInfo, updateErrorMessages } from '../../Redux/DataSlice'
          ...
          <div className="row font" >
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  ...
                  <div className="col-sm-10  col-12">
                      <TextField type="text"  elementId="Email" placeholder='users@example.com' 
                            validation={
          ...
          <div className="row font" >
              <div className="col-lg-6 col-12 pt-5 px-4">
                <div className='row '>
                  ...
                  <div className='col-sm-10 col-12'>
                      <TextField type="text" elementId="Address1" 
              ...
              <div className="col-lg-6 col-12 pt-5  px-4">
                <div className='row'>
                  ...
                  <div className='col-sm-10 col-12'>
                    <TextField type="text" elementId="Address2" value={personalHeads.Address2}
