...
import {templateImagesPaths} from '../Components/Data/Data'//templateImagesPaths is imported from Data.js which is used to display static images of various templates on the Home page.
    ...
    return (
        <div style={{minWidth:'300px'}}>
            ...
            <div className='d-flex justify-content-center mt-2' >
                ...
                <h1 className='p-2 rounded'>Resume Template</h1>
            </div>
